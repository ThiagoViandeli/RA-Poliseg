  ...
  return (
    <div className="min-h-screen bg-[#edf1e6] text-black font-sans selection:bg-[#FACC15] selection:text-black">
      ...
      {/* 
        Slide 1: Hero
      */}
      <section id="inicio" className="min-h-screen flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 pt-16 md:pt-20 pb-8 md:pb-12 border-b border-[#d4d4d8]">
      ...
      {/* 
        Slide 2: History
      */}
      <section id="historia" className="min-h-[80vh] md:min-h-screen flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 bg-[#e4e9dc] border-b border-[#d4d4d8]">
        <header className="mb-auto">
        </header>
      ...
      */}
      <section id="especialidade" className="min-h-[80vh] md:min-h-screen flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 bg-[#edf1e6] border-b border-[#d4d4d8]">
        <header className="mb-auto">
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-24 text-zinc-800 text-[15px] md:text-[17px] font-light leading-relaxed mb-12 md:mb-24">
          ...
          {/* Right Column */}
          <div className="space-y-4 md:space-y-6 max-w-2xl text-base md:text-[18px] bg-[#09667999] rounded-2xl p-6 sm:p-8 md:p-12 text-white/80">
      ...
      */}
      <section id="linhas" className="flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 bg-[#e4e9dc]">
      ...
      <footer className="bg-[#096679] text-white py-10 md:py-16 px-4 sm:px-8 md:px-12 lg:px-16">

        ...
        <div className="mt-auto -mx-4 sm:-mx-8 md:-mx-12 lg:-mx-16 bg-black px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-20">
          <div className="space-y-8 max-w-4xl mx-auto w-full text-center">
            <div>
              ...
              <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-7 gap-x-6 sm:gap-x-8 md:gap-x-12 gap-y-8 md:gap-y-16 items-center">
                ...
                <img src="/metlife_logo.png" alt="MetLife" className="h-5 md:h-6 object-contain brightness-0 invert mx-auto" />

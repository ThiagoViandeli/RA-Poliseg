      ...
      <section className="min-h-screen flex flex-col p-8 md:p-12 lg:p-16 bg-[#e4e9dc]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-24 text-sm font-light text-zinc-800">
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-[18px]">Empresas e Operações
</h4>
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-[18px]"> Patrimônio e Estrutura Familiar
</h4>
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-[18px]"> Riscos Específicos e Patrimônio de Alta Complexidade
</h4>

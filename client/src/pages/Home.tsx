                  ...
                  >
                    {[1, 2].map((set) => (
                      <div key={set} className="flex items-center gap-16 px-8">
                        <img src="/eztec_logo.png" alt="Eztec" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 shrink-0" />
                        <img src="/kallas_logo.png" alt="Kallas" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 shrink-0" />
                        <img src="/trisul_logo.png" alt="Trisul" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 shrink-0" />
                        <img src="/fraiha_logo.png" alt="Fraiha" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 shrink-0" />
                        <img src="/amy_logo.png" alt="Amy" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 mix-blend-multiply shrink-0" />
                        <img src="/constrak_logo.png" alt="Constrak" className="h-8 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 mix-blend-multiply shrink-0" />
                        <img src="/cemek_logo.png" alt="Cemek" className="h-10 object-contain grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 mix-blend-multiply shrink-0" />
                      </div>
                    ))}
                  </motion.div>
                </div>

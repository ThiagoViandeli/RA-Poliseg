    ...
    <div className="min-h-screen bg-white text-black font-sans selection:bg-[#FACC15] selection:text-black">
      ...
      */}
      ...
      {/* 
        Slide 2: History
      */}
      <section id="historia" data-stack className="flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 py-40 md:py-64 bg-white border-b border-[#d4d4d8] lg:sticky lg:top-0">

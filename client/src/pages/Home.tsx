...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-[#FACC15] selection:text-black">
      ...
      */}
      <section id="especialidade" className="min-h-[80vh] md:min-h-screen flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 bg-white border-b border-[#d4d4d8] overflow-hidden sticky top-0">
        <header className="mb-auto">
        </header>

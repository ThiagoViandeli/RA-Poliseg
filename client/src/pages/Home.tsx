    ...
    <div className="min-h-screen bg-[#edf1e6] text-black font-sans selection:bg-[#FACC15] selection:text-black">
      ...
      */}
      <section id="inicio" className="min-h-screen flex flex-col p-8 md:p-12 lg:p-16 border-b border-[#d4d4d8] pt-[0px] pb-[0px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-12">
          ...
          {/* Right Column */}
          <div className="lg:col-span-6 flex flex-col justify-end space-y-6 text-zinc-800 md:text-[17px] font-light max-w-2xl text-[21px]" style={{ fontSynthesis: "weight style" }}>
            <p>
      ...
      */}
      ...
      <a
        ...
        className="fixed bottom-6 left-6 z-50 bg-[#25D366] hover:bg-[#1ebe57] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-105"

      ...
      */}
      <section id="inicio" className="min-h-screen flex flex-col p-8 md:p-12 lg:p-16 border-b border-[#d4d4d8] pt-[0px] pb-[0px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-12">
          {/* Left Column */}
          <div className="lg:col-span-6 flex flex-col justify-end bg-[#09667966] rounded-2xl p-8 md:p-12 pt-[22px] pb-[22px]">
          ...
          {/* Right Column */}
          <div className="lg:col-span-6 flex flex-col justify-end space-y-6 text-zinc-800 md:text-[17px] font-light max-w-2xl text-[22px]" style={{ fontFamily: "'Raleway', sans-serif", fontSynthesis: "weight style" }}>

      ...
      */}
      <section className="min-h-screen flex flex-col p-8 md:p-12 lg:p-16 border-b border-[#d4d4d8] pt-[0px] pb-[0px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-12">
          ...
          {/* Right Column */}
          <div className="lg:col-span-6 flex flex-col justify-end space-y-6 text-zinc-800 text-[15px] md:text-[17px] font-light leading-relaxed max-w-2xl" style={{ fontSynthesis: "none" }}>
            <p>

...
function BrandStatement() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const textEls = el.querySelectorAll('h2, p, .gsap-reveal');
      ...
      <section id="linhas" className="flex flex-col px-4 sm:px-8 md:px-12 lg:px-16 pt-12 md:pt-16 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 md:mb-24 text-sm font-light text-zinc-800">
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-base md:text-lg min-h-[4rem] md:min-h-[3rem]">Empresas e Operações</h4>
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-base md:text-lg min-h-[4rem] md:min-h-[3rem]">Patrimônio e Estrutura Familiar</h4>
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-base md:text-lg min-h-[4rem] md:min-h-[3rem]">Riscos Específicos e Patrimônio</h4>
          ...
          <div>
            ...
            <h4 className="text-black font-medium mb-2 text-base md:text-lg min-h-[4rem] md:min-h-[3rem]">Engenharia e Grandes Obras</h4>
          ...
          <div className="space-y-8 max-w-4xl mx-auto w-full text-center">
            <div>
              ...
              <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-10">
                ...
                <img src="/HDI_Seguros_Brasil_-_Logo_2020-removebg-preview.png" alt="HDI Seguros" className="h-10 md:h-14 object-contain brightness-0 invert" />
                <img src="/Yelum-removebg-preview.png" alt="Yelum Seguradora" className="h-10 md:h-14 object-contain brightness-0 invert" />

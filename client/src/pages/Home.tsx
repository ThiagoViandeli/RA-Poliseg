      ...
      */}
      <section className="min-h-screen flex flex-col p-8 md:p-12 lg:p-16 bg-[#e4e9dc]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-24 text-sm font-light text-zinc-800">
          {/* Category 1 */}
          <div>
            <img src="/icon_folder_pc.png" alt="Empresas e Operações" className="w-[250px] h-[251px] mb-6 object-contain -ml-10 animate-float" />
            ...
            <ul className="space-y-3 border-t border-[#d4d4d8] pt-4 font-extrabold">
          ...
          <div>
            ...
            <ul className="space-y-3 border-t border-[#d97706]/40 pt-4 text-black font-extrabold">

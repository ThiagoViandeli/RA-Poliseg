      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#d4d4d8]/30">
        <div className="flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-16 py-3 md:py-4">
          ...
          <ul className="hidden md:flex items-center gap-4 lg:gap-8 text-[10px] lg:text-xs uppercase tracking-[0.15em] font-medium text-zinc-600">
            ...
            <li><a href="/historia" className="hover:text-black transition-colors">Nossa História</a></li>
            <li><a href="/especialidade" className="text-black transition-colors">Especialidade</a></li>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-[#d4d4d8]/30 px-4 pb-4">
            <ul className="flex flex-col gap-3 text-xs uppercase tracking-[0.15em] font-medium text-zinc-600 pt-3">
              ...
              <li><a href="/historia" className="block py-2 hover:text-black transition-colors" onClick={() => setMobileMenuOpen(false)}>Nossa História</a></li>
              <li><a href="/especialidade" className="block py-2 text-black" onClick={() => setMobileMenuOpen(false)}>Especialidade</a></li>
        ...
        <div className="flex flex-col gap-8 md:gap-12 max-w-3xl mt-12">
          ...
          <div className="fade-in rounded-2xl p-6 sm:p-8 bg-zinc-50">
            ...
            <ul className="space-y-3 text-black">
              ...
              <li className="flex items-start gap-3"><span className="mt-1.5 text-[8px]">■</span><span>Contratos envolvidos</span></li>
              <li className="flex items-start gap-3"><span className="mt-1.5 text-[8px]">■</span><span>Exigências legais e regulatórias</span></li>
              <li className="flex items-start gap-3"><span className="mt-1.5 text-[8px]">■</span><span>Visão patrimonial e financeira</span></li>
            </ul>
          </div>
